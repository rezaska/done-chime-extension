...
This extension does **not** collect, store, or transmit any user data. All settings live in your browser's local storage, and all sounds are synthesized locally. See [`privacy-policy.html`](privacy-policy.html) for details.
